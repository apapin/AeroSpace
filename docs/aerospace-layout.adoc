...
* `tiles|accordion|stack` - Change tiling layout but preserve orientation (`stack` ignores orientation while active)
...
* Make every child of the focused container occupy the same full-size stack region: +
`aerospace layout stack`
